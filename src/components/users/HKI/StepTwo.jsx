...
const Step2 = ({ formData, handleChange, handleBack, handleNext }) => {
  ...
  const [paymentMethod, setPaymentMethod] = useState("mandiri"); // tambahkan state untuk metode pembayaran


  useEffect(() => {
    const storedSubmissionDataId = localStorage.getItem("submissionDataIdHKI");
    const storedSubmissionId = localStorage.getItem("submissionIdHKI");
